...
export default {
  ...
  channel: {
    ...
    // 项目地址
    itemUrl: "http://192.168.1.6:9090/#/",
    // 首页地址
    indexUrl: "/seckill/index",
    // 支付授权地址
    payAuthUrl: "http://192.168.1.6:9090/#/payment/payChannel",
    // 未登录重定向地址
    notLoginRedirectUrl: "http://192.168.1.6:9090/#/user/loginPhoneCode",
    // 渠道编码
    id: "100042",
    // 渠道名称
    name: "测试渠道",
  ...
  seckill: {
    ...
    // Banner图地址
    banner:
      "//zpyl.static.piaowutong.cc/201912/5E86EA863F484F5C94B2D5837FB833EB.jpg",
    // 活动说明图地址
    info:
      "//zpyl.static.piaowutong.cc/201912/AADA6DD61AED48AF86E1B0881DF91992.jpg"
  },
